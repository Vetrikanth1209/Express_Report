...
const SERVICE_HOST = "express-report.onrender.com";
...
const registerService = async () => {
  try {
    ...
    console.log("✅ Mod Service successfully registered in Consul");
  } catch (err) {
...
process.on("SIGINT", async () => {
  try {
    ...
    console.log("✅ Report Service deregistered from Consul");
    process.exit(0);
  } catch (err) {
